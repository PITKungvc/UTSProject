    ...
    <div className="min-h-screen flex flex-col bg-[#a8cfa1]">
      ...
      <main className="flex flex-1 items-center justify-center p-6">
        <form
          ...
          className="w-full max-w-[280px] rounded-lg border border-black/10 bg-white/60 p-6 shadow-[0_8px_24px_rgba(0,0,0,0.08)] backdrop-blur-[2px]"
        >
          ...
          <div className="mt-4 flex flex-col text-[12px] text-black">
            ...
            <select
              ...
              className="w-full rounded-[4px] border border-slate-500 bg-white px-2 py-2 text-[12px] outline-none focus:border-green-700 focus:ring-2 focus:ring-green-700/30"
            >
          ...
          <button
            type="submit"
            className="mt-4 w-full rounded-[4px] bg-[#8bff71] px-2 py-2 text-center text-[12px] font-semibold text-black hover:brightness-95"
          >
            REGISTER
          </button>
